...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Firebase mStudentsRef = new Firebase(App.FIREBASE_ROOT);

            mStudentsRef.authWithPassword(mEmail, mPassword, new Firebase.AuthResultHandler() {
                @Override
                public void onAuthenticated(AuthData authData) {
                    SharedPreferences.Editor editor = getApplication().getSharedPreferences("User", getApplication().MODE_PRIVATE).edit();
                    editor.putString("_id", authData.getUid());
                ...
                public void onAuthenticationError(FirebaseError firebaseError) {
                    Log.e("onAuthenticationError", firebaseError.getMessage());
                }
            });
            return true;
        }
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                i = new Intent(getApplication(), CoursesListActivity.class);
                startActivity(i);
                finish();
            } else {
